...
class AudioVisualizer(Overlay):
    ...
    def __init__(self, name=None, width=150, height=24, bars=20, **kwargs):
        ...
        # Create spectrum renderer
        self.spectrum_render = SpectrumRender()
        self.spectrum_box = self.spectrum_render.get_spectrum_box()

        # Set size
        self.spectrum_box.set_size_request(width, height)

        # Add to overlay
        self.add_overlay(self.spectrum_box)
    ...
    def set_visible(self, visible):
        """Override set_visible to control spectrum rendering"""
