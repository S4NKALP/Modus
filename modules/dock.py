...
class Dock(Window):
    ...
    def __init__(self, **kwargs):
        ...
        # Dock is always positioned at the bottom
        ...
        # Dock is always horizontal, so remove vertical style class
        self.wrapper.remove_style_class("vertical")

        # Always use Dense theme
        ...
        # Create corners for horizontal dock at bottom
    ...
    def create_button(self, app_identifier, instances):
        ...
        # Add dot indicator for open apps
        if instances:
            dot = Box(
                name="dock-app-dot",
                h_align="center",
    ...
    def hide_dock_if_not_hovered(self):
        ...
        if (
            ...
            if self.always_occluded:
                ...
                occlusion_region = ("bottom", self.effective_occlusion_size)
